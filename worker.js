...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Cpath d='M14 0h28l22 22v28a14 14 0 0 1-14 14H14A14 14 0 0 1 0 50V14A14 14 0 0 1 14 0z' fill='%23356b53'/%3E%3Cpath d='M42 0v22h22L42 0z' fill='%23fffefa' opacity='.55'/%3E%3Ctext x='28' y='47' font-family='Georgia,serif' font-style='italic' font-size='42' fill='%23fffefa' text-anchor='middle'%3En%3C/text%3E%3C/svg%3E">
    <style>
        :root {
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-mark { position: relative; display: inline-flex; width: 35px; height: 35px; border-radius: 10px; align-items: center; justify-content: center; padding: 4% 9% 0 0; background: var(--accent); color: var(--bg-primary); font-family: Georgia, serif; font-size: 25px; font-style: italic; font-weight: normal; flex-shrink: 0; clip-path: polygon(0 0, 66% 0, 100% 34%, 100% 100%, 0 100%); }
