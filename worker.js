...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Cpath d='M14 0h28l22 22v28a14 14 0 0 1-14 14H14A14 14 0 0 1 0 50V14A14 14 0 0 1 14 0z' fill='%23356b53'/%3E%3Cpath d='M42 0v22h22L42 0z' fill='%23fffefa' opacity='.55'/%3E%3Ctext x='31' y='44' font-size='38' text-anchor='middle'%3E✨%3C/text%3E%3C/svg%3E">
    <style>
        :root {
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-mark { position: relative; display: inline-flex; width: 35px; height: 35px; border-radius: 10px; align-items: center; justify-content: center; background: var(--accent); font-family: 'Apple Color Emoji', 'Segoe UI Emoji', 'Noto Color Emoji', sans-serif; font-size: 22px; line-height: 1; flex-shrink: 0; clip-path: polygon(0 0, 66% 0, 100% 34%, 100% 100%, 0 100%); }
        .brand-mark::after { content: ''; position: absolute; top: 0; right: 0; width: 34%; height: 34%; background: var(--bg-primary); opacity: .55; clip-path: polygon(0 0, 0 100%, 100% 100%); }
        ...
        .logo .brand-mark { width: 31px; height: 31px; font-size: 18px; border-radius: 9px; }
    ...
    <div id="login-screen">
        <div class="login-shell">
            <section class="login-story" aria-label="note 私人写作空间">
                <div class="story-brand"><span class="brand-mark" aria-hidden="true">✨</span> note <span class="eyebrow">/ 私人写作空间</span></div>
    ...
    <div id="app">
        <header>
            <div class="header-brand">
                ...
                <div class="logo"><span class="brand-mark" aria-hidden="true">✨</span><span class="logo-text">note</span><small>留一页给灵感</small></div>
            </div>
            <div class="controls">
